...
const Navigation = ({ currentView, setCurrentView }) => {
  // Primary navigation items (5 most important features)
  ...
  // Secondary items accessible through home or settings
  const allNavItems = [
    { id: 'dashboard', label: 'Home', icon: Home },
    { id: 'todos', label: 'Tasks', icon: CheckSquare },
    { id: 'period', label: 'Period', icon: Calendar },
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-dolphin border-t border-dolphin/10 px-4 py-2 z-50">
